 ...
 * Description:       Add a dropdown to s elect a street by city in Israel for any form with city-street (or city only) fields (Woocommerce,Contact form 7, Elementor). 
 * Version:           1.0.0
 * Author:            Yehuda Tiram
